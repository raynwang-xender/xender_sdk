...
public abstract class NanoHTTPD {
     ...
     */
    public NanoHTTPD(String hostname, int port, String tempFilePath) {
    ...
    public void start() throws IOException {
        ...
        Port.setWebPort(myServerSocket.getLocalPort());
        Logger.d("port","now new port:"+Port.getWebPort());
    ...
    public static class DefaultTempFileManager implements TempFileManager {
        ...
        public DefaultTempFileManager(String tmpFilePath) {
            tmpdir = tmpFilePath;
    ...
    public static class Response {
        ...
        public Response(IStatus status, String mimeType, byte[] bytes) {
            this.status = status;
            this.mimeType = mimeType;
            this.data = bytes != null ? new ByteArrayInputStream(bytes) : null;
        }
        ...
        protected void sendAsChunked(OutputStream outputStream, PrintWriter pw)
                throws IOException {
    ...
    private class DefaultTempFileManagerFactory implements
        ...
        public DefaultTempFileManagerFactory(String tempFilePath) {
            tmpFilePath = tempFilePath;
        }

        @Override
        public TempFileManager create() {
            return new DefaultTempFileManager(tmpFilePath);
        }
    }
    ...
    public interface IHTTPSession {
         ...
         */
        void parseBody(Map<String, String> files) throws Exception;
    }
    ...
    protected class HTTPSession implements IHTTPSession {
        ...
        public HTTPSession(TempFileManager tempFileManager,
            ...
            this.inputStream = new MyPushbackInputStream(inputStream, BUFSIZE);
